...
EMBEDDING_MODELS = [
    # ── Local (sentence-transformers, in-process) — default dimensions ──
    {
        "id": "BAAI/bge-m3",
        "provider": "LOCAL",
        "dim": 1024,
        "label": "BGE-M3",
        "note": "Local · gratuit · qualité élevée · multilingue",
    ...
    },
    {
        ...
        "note": "Local · gratuit · multilingue · longs documents",
        "speed": 1,
        "available": True,
    },
    # ── Ollama (local daemon, no key) — default dimensions ──
    {
        "id": "qwen3-embedding:0.6b",
        "provider": "OLLAMA",
        "dim": 1024,
        "label": "Qwen3-Embedding 0.6B",
        "note": "Ollama · local · 1024d · multilingue",
        "speed": 2,
        "available": True,
    },
    {
        ...
        "note": "Ollama · local · 2560d · haute qualité",
        "speed": 1,
        "available": True,
    },
    # ── Léger & CPU-friendly ──
    {
        ...
        "note": "Ollama · léger · CPU-friendly · 768d",
        "speed": 3,
        "available": True,
    },
    {
        ...
        "note": "Ollama · léger · CPU-friendly · 768d · multilingue",
        "speed": 3,
        "available": True,
    },
    {
        ...
        "dim": 384,
        "label": "all-minilm",
        "note": "Ollama · le plus rapide · 384d",
        "speed": 3,
        "available": True,
    },
