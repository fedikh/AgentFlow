"""
Datasets — loader: case CRUD, flexible file parsing (.xlsx/.csv/.json via
pandas/openpyxl, EN+FR headers), and the expert-facing templates (interactive
HTML form, Excel with dropdowns, JSON).
"""
